"""Connecteur API asynchrone : orchestre les appels vers un ERP/CRM existant en REST.

Lecture (fiche client, tickets) et write-back idempotent (creation de ticket). Le client
HTTP asynchrone est injecte pour permettre les tests sans reseau.
"""
...
class ApiConnector:
    """Encapsule les appels metier vers l'ERP/CRM via un client HTTP async injecte."""
